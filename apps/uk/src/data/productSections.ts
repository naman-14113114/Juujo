...
export const torchDetailImages = [
  {
    ...
    alt: "Juujo Grounding Sheet detail image",
  },
  {
    src: productAsset("custom-image-v2-1.png", "grounding-sheets"),
    alt: "Juujo Grounding Sheet wellness use",
  },
  {
    src: productAsset("custom-image-v2-2.png", "grounding-sheets"),
    alt: "Juujo Grounding Sheet treatment application",
  },
];
...
export const expertVideo = {
  poster: productAsset("Bed_Sheet_-_New_Hero_18-04-26.jpg"),
