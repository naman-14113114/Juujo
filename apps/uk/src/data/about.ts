export const aboutHero = {
  ...
  copy: "Juujo is a premium bedding brand built around one idea: better sleep should feel effortless. We design grounding sheets, weighted blankets, cooling bed sheets, and pillows with breathable materials and honest craftsmanship, so your bed becomes the calmest part of your day.",
...
export const aboutSections = [
  {
    ...
    eyebrow: "Who we are",
    title: "Our Team",
    copy: "Behind Juujo is a small team of makers who care about how a bed feels. We test every sheet, blanket, and pillow ourselves, from the weave and the weight to how it washes after months of use. From product design to customer care, everyone here shares one goal: helping you rest better, night after night.",
    image: {
  ...
  },
  {
    ...
    copy: "We are here to help with sizing, orders, or anything else. Reach our team at:\n\n- Email: support@juujo.com\n- Operating Hours: Monday to Friday, 9am - 5pm GMT",
    image: {
