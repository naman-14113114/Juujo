...
export const metadata: Metadata = {
  title: "My Profile",
  description: "Manage your Juujo customer profile.",
  robots: {
    index: false,
    follow: false,
  },
      ...
      <div className="juujo-wrap">
        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-[1fr_360px]">
          <div className="rounded-[2rem] border border-[var(--border)] bg-[var(--card)] p-6 md:p-8">
            <h2 className="juujo-display text-3xl text-[var(--plum)]">
              Profile details
            </h2>
            <div className="mt-6">
          ...
          <aside className="space-y-5">
            <div className="rounded-[2rem] border border-[var(--border)] bg-[var(--card)] p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="juujo-mono text-[var(--gold)]">Default address</p>
            ...
            <div className="rounded-[2rem] border border-[var(--border)] bg-[var(--card)] p-6">
              <p className="juujo-mono text-[var(--gold)]">Recent orders</p>
