...
function TorchSpotlight() {
  ...
  return (
    <section className="juujo-section bg-[var(--plum)] py-12 md:py-16 text-[var(--cream)]">
...
function SkincareGuideIntro() {
  return (
    <section className="juujo-section bg-[var(--cream)] py-20 md:py-24">
...
function HomeFeatureGrid() {
  return (
    <section className="juujo-section bg-[var(--cream)] py-24">
      <div className="juujo-wrap">
        <SectionHeading
          eyebrow="Why Juujo"
          title={
...
function LightTherapyStory() {
  return (
    <section
      className="juujo-section bg-[var(--plum)] py-24 text-[var(--cream)]"
      id="light-therapy"
    >
...
function HomeVideoHero() {
  return (
    <section className="juujo-section relative w-full overflow-hidden bg-[var(--plum)]">
      <video
        autoPlay
        loop
        muted
