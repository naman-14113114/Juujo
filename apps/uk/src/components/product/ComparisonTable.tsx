      ...
      <div className="flex flex-col md:flex-row md:items-stretch">
        ...
        <div className="w-full md:w-1/3 pr-4 py-2 md:py-2.5 flex items-center">
          <div className="flex items-center gap-2">
            <span
              className="juujo-mono inline-flex items-center justify-center font-bold text-[9px] uppercase text-white rounded-lg h-[18px] w-[81px] tracking-wider shrink-0"
              style={{ backgroundColor: colorCode }}
            >
              {colorName}
            </span>
            <span className="juujo-display text-[var(--plum)] text-sm md:text-base font-normal">
              {description}
            </span>
          </div>
        </div>
...
export function ComparisonTable() {
  return (
    <section className="juujo-section bg-[var(--cream)] md: md: py-14 md:py-24">
      <div className="juujo-wrap max-w-[1144px]">
        ...
        <div className="mt-8 flex flex-col md:mt-12">
          ...
          <ComparisonRow
            ...
            values={[
              <strong key="1" className="juujo-display font-bold text-sm md:text-base text-[var(--plum)]">3 MINS</strong>,
              <strong key="2" className="juujo-display font-bold text-sm md:text-base text-[var(--muted)]">10 MINS</strong>,
              <strong key="3" className="juujo-display font-bold text-sm md:text-base text-[var(--muted)]">10 MINS</strong>,
              <strong key="4" className="juujo-display font-bold text-sm md:text-base text-[var(--muted)]">10 MINS</strong>,
            ]}
          />
