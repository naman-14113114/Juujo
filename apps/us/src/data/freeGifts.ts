...
const bundleFooter =
  "The Juujo LED Mask offer works best as a complete ritual: the mask, the travel case, the LED Torch, and the customer skincare guide all support the same goal.";
...
export const freeGiftDetails: FreeGiftDetail[] = [
  {
    ...
    seoTitle: "Premium Travel Box for Juujo LED Mask",
    seoDescription:
      "Discover the premium travel box included with the Juujo LED Mask offer for protected storage, organized accessories, and easier travel.",
    intro:
      "The Premium Travel Box is the practical bonus most customers do not realize they will appreciate until the mask becomes part of their weekly routine. It gives your Juujo LED Mask a dedicated home, protects it between sessions, and makes travel much easier.",
    note:
      "This travel box is currently included as a free bonus with the Juujo LED Mask offer.",
    image: productMediaAsset("ChatGPT Image May 31, 2026, 11_53_13 PM.png"),
    imageAlt: "Premium Travel Box for the Juujo LED Mask",
  ...
  },
  {
    ...
    eyebrow: "Free Bonus Gift",
    title: "Juujo LED Torch",
    seoTitle: "Juujo LED Torch Bonus Gift",
    seoDescription:
      "Explore the targeted Juujo LED Torch included as a free companion gift with the Juujo LED Mask offer.",
    intro:
      "The Juujo LED Torch adds precision to the main mask offer. While the LED Mask gives you broad face-and-neck coverage, the torch gives you a smaller tool you can use for targeted touch-up areas and travel-friendly sessions.",
    note:
      "The current Juujo LED Mask offer includes the LED Torch as a free bonus gift.",
    image: productMediaAsset("free_torch.png"),
    imageAlt: "Juujo LED Torch bonus gift",
  ...
  },
  {
    ...
    title: "The Juujo Skincare Guide",
    seoTitle: "The Juujo Skincare Guide Bonus",
    seoDescription:
      "Learn what is inside the Juujo Skincare Guide delivered after your LED Mask purchase, including wavelength guidance and treatment plans.",
    intro:
      "This is not a generic PDF. It is a full Juujo customer guide designed to help LED Mask buyers get more value out of the device from day one. It explains the wavelengths, shows how to build a routine, and turns uncertainty into a clear treatment plan.",
    note:
      "The Juujo Skincare Guide is delivered after your LED Mask purchase. The private guide file is not published on this page.",
    image: productMediaAsset("free_guide-v2.webp"),
    imageAlt: "Juujo Skincare Guide bonus",
    ...
    sections: [
      {
        ...
        paragraphs: [
          "The guide walks customers through the Juujo method from first principles to practical routines. It covers the science of LED light therapy, the role of each wavelength, skin-type matching, weekly protocols, morning and evening rituals, and the best ingredients to pair with LED sessions.",
          "It also includes a results timeline, travel tips, routine examples by decade, common myths, and a bonus chapter on the Juujo IPL ritual.",
        ],
        bullets: [
