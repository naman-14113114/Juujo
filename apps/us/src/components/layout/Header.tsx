...
export function Header() {
  ...
  return (
    ...
    >
      <div className="juujo-wrap relative flex min-h-[64px] items-center justify-between gap-4 lg:min-h-[72px] lg:gap-6">
        <button
        ...
        <Link
          ...
          href="/"
          aria-label="Juujo home"
        >
          <Image
            alt="Juujo Logo"
            className="h-[clamp(40px,4vw,50px)] w-auto object-contain mix-blend-multiply"
            height={74}
            priority
        ...
        <div className="flex items-center gap-3 lg:gap-6">
          ...
          >
            ...
            {totals.itemCount > 0 ? (
              <span className="juujo-mono absolute -right-1 -top-1 grid h-5 min-w-5 place-items-center rounded-full bg-[var(--plum)] px-1 text-[0.58rem] leading-none text-[var(--cream)]">
                {totals.itemCount}
              </span>
            ) : null}
          </button>
            ...
            {accountMenuOpen ? (
              ...
              >
                <div className="border-b border-[var(--border)] p-4">
                  <p className="juujo-mono text-[var(--gold)]">
                    {signedIn ? "Signed in" : "Juujo account"}
                  </p>
                ...
                <div className="p-2">
                  {signedIn ? (
                    ...
                    <>
                      <HeaderMenuLink href="https://juujo.com/sign-in" label="Sign in" />
                      <HeaderMenuLink href="https://juujo.com/sign-up" label="Sign up" />
                    </>
                  )}
                </div>
              </div>
            ...
            >
              ...
              >
                ...
                <div className="flex-1 px-4 py-5">
                  ...
                  <p className="juujo-eyebrow mt-7 px-2">Help</p>
                  ...
                  <p className="juujo-eyebrow mt-7 px-2">Account</p>
                  <div className="mt-2">
                    {signedIn ? (
                      <>
                        <MobileMenuLink
                      ...
                      <>
                        <MobileMenuLink
                          href="https://juujo.com/sign-in"
                          label="Sign in"
                          onClick={() => setMobileMenuOpen(false)}
                        />
                        <MobileMenuLink
                          href="https://juujo.com/sign-up"
                          label="Sign up"
                          onClick={() => setMobileMenuOpen(false)}
                        />
                      </>
