...
const groundingPillowcaseFeatures = [
  {
  ...
  },
  {
    ...
    kicker: "Clean & Fresh",
    body: "Silver helps prevent odor-causing bacteria, keeping pillowcases cleaner and more hygienic between washes.",
    icon: IconShieldCheck,
  },
  {
    title: "Eco-Friendly & Chemical-Free",
    kicker: "Safe & Non-Toxic",
    body: "Every pillowcase is crafted from responsibly sourced, non-toxic materials. They're free of harsh chemicals and safe for both your skin and the planet.",
    icon: IconHeart,
  },
  {
...
const accordionData = [
  {
    eyebrow: "Features",
    title: "What makes our pillowcases unique?",
    content: (
      <ul className="grid gap-3">
        {groundingPillowcaseFeatures.map((feature, index) => {
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4 text-[var(--muted)] text-[16px] md:text-[18px]">
        <p>
          Our grounding pillowcase is designed to replace your regular
          bedpillowcase while providing a comfortable and secure fit for everyday
          use.
        </p>
        ...
        <div>
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li>pillowcase for mattresses up to 30cm deep</li>
            <li>Fits most standard and queen pillows</li>
            <li>Can be used alone or layered</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>
              Can be used alone or under your regular pillowcase. Compatible with
...
export function PillowcaseAccordions() {
