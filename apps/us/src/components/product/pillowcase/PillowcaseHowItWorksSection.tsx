...
export function PillowcaseHowItWorksSection() {
  const steps = [
    {
      num: "01",
      description: "Place the Grounding Pillowcase over your pillow",
      video: "pillowcase-how-to-use-1.mp4",
    },
    {
      num: "02",
    ...
    >
      <div className="juujo-wrap">
        <SectionHeading
          ...
          copy="Setting up your Juujo Grounding Pillowcase takes less than two minutes. No complex wiring required."
          align="center"
        />
