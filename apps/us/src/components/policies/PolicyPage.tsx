...
export function PolicyPage({ policyType }: PolicyPageProps) {
  ...
  return (
    <div className="bg-[var(--cream)] min-h-screen py-16 md:py-24 relative overflow-hidden">
      ...
      <div className="juujo-glow -left-24 top-12 h-[380px] w-[380px] bg-[#f4a17b] opacity-10" />
      <div className="juujo-glow -right-20 bottom-12 h-[420px] w-[420px] bg-[#a05080] opacity-10" />
      ...
      <div className="juujo-wrap relative z-10 max-w-4xl px-4 sm:px-6">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="juujo-mono text-[var(--gold)] tracking-[0.2em] uppercase text-xs font-semibold">
            Store Policies
          </p>
        ...
        <style
          dangerouslySetInnerHTML={{
            __html: `
              .juujo-policy-content h2,
              .juujo-policy-content h3,
              .juujo-policy-content h4,
              .juujo-policy-content strong {
              ...
              .juujo-policy-content p {
                margin-bottom: 1.2rem;
                line-height: 1.8;
              }
              .juujo-policy-content ul {
                list-style-type: disc;
                padding-left: 1.5rem;
                margin-bottom: 1.2rem;
              }
              .juujo-policy-content li {
                margin-bottom: 0.5rem;
              }
              .juujo-policy-content a {
                color: var(--plum);
                text-decoration: underline;
                font-weight: 400;
              }
              .juujo-policy-content a:hover {
                color: var(--ink);
              }
              .juujo-policy-table-wrap {
                margin-bottom: 1.5rem;
                overflow-x: auto;
                width: 100%;
              }
              .juujo-policy-content table {
                border-collapse: collapse;
                min-width: 38rem;
                width: 100%;
              }
              .juujo-policy-content th,
              .juujo-policy-content td {
