...
export const metadata: Metadata = {
  ...
  description: "Your Juujo order confirmation.",
  robots: {
    index: false,
    follow: false,
  },
    ...
    <section className="juujo-section bg-[var(--cream)] py-16 md:py-24">
      <div className="juujo-wrap">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="juujo-eyebrow mt-5">Sale recorded</p>
          <h1 className="juujo-heading mt-3">Thank you, {order.customer_full_name}.</h1>
          <p className="juujo-copy mx-auto mt-5 max-w-2xl">
            Your Juujo order has been recorded as {order.order_number}. A real
        ...
        <div className="mx-auto mt-12 grid max-w-5xl gap-8 lg:grid-cols-[1fr_360px]">
          <div className="rounded-[2rem] border border-[var(--border)] bg-[var(--card)] p-5 md:p-6">
            <div className="flex flex-col justify-between gap-4 border-b border-[var(--border)] pb-5 md:flex-row md:items-center">
              <div>
                <p className="juujo-mono text-[var(--gold)]">Order</p>
                <h2 className="juujo-display mt-2 text-3xl text-[var(--plum)]">
                  {order.order_number}
                </h2>
              ...
              <p className="juujo-display text-4xl text-[var(--plum)]">
          ...
          <aside className="space-y-5">
            <div className="rounded-[2rem] border border-[var(--border)] bg-[var(--card)] p-6">
              <p className="juujo-mono text-[var(--gold)]">Customer</p>
              <h2 className="juujo-display mt-3 text-3xl text-[var(--plum)]">
            ...
            <div className="rounded-[2rem] border border-[var(--border)] bg-[var(--card)] p-6">
              <p className="juujo-mono text-[var(--gold)]">Summary</p>
...
function OrderSetupNotice({ orderNumber }: { orderNumber: string }) {
  return (
    <section className="juujo-section bg-[var(--cream)] py-20 md:py-28">
      <div className="juujo-wrap max-w-2xl text-center">
        <PackageCheck className="mx-auto text-[var(--gold)]" size={46} />
        <h1 className="juujo-heading mt-5">Order storage needs setup.</h1>
        <p className="juujo-copy mx-auto mt-5 max-w-lg">
