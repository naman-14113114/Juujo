    ...
    <form action={formAction} className="grid gap-5">
      <div className="grid gap-5 md:grid-cols-2">
        <label className="block">
          <span className="juujo-mono text-[var(--plum)]">Full name</span>
          <input
        ...
        <label className="block">
          <span className="juujo-mono text-[var(--plum)]">Email</span>
          <input
        ...
        <label className="block">
          <span className="juujo-mono text-[var(--plum)]">Phone</span>
          <input
            autoComplete="tel"
        ...
        <label className="block">
          <span className="juujo-mono text-[var(--plum)]">Country</span>
          <input
      ...
      <label className="block">
        <span className="juujo-mono text-[var(--plum)]">Shipping address</span>
        <input
      ...
      <label className="block">
        <span className="juujo-mono text-[var(--plum)]">Apartment, suite, etc.</span>
        <input
      ...
      <div className="grid gap-5 md:grid-cols-3">
        <label className="block">
          <span className="juujo-mono text-[var(--plum)]">City</span>
          <input
        ...
        <label className="block">
          <span className="juujo-mono text-[var(--plum)]">State</span>
          <input
        ...
        <label className="block">
          <span className="juujo-mono text-[var(--plum)]">Postal code</span>
          <input
      ...
      <label className="flex items-start gap-3 rounded-2xl border border-[var(--border)] bg-[rgba(241,223,210,.32)] p-4 text-sm text-[var(--muted)]">
        ...
        />
        <span>
          Send me Juujo care tips, offer updates, and early product news.
        </span>
      </label>
