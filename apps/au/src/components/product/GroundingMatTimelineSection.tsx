  ...
  const timeline = [
    {
      ...
      description: "Just moments after resting your feet on the grounding mat, your blood flow can start to enhance as red blood cells un-clump. This process helps your body achieve a warmer, calmer, and more physically relaxed state.",
      image: "/media/journey/step-3.gif",
    },
    {
      label: "Day 1",
      title: "Your Body Begins to Relax",
      description: "Many users experience a growing sense of calm and comfort after their first day with the grounding mat. As inflammation subsides and circulation increases, physical discomforts like stiffness and tension can diminish, leaving you feeling more at ease throughout the day.",
      image: "/media/journey/mat-day-1.webp",
    },
    {
      label: "Week 1",
      title: "Reduced Tension During Work",
      description: "Following a week of consistent use, many individuals feel noticeably more relaxed while sitting at their desk or lounging. With improved blood flow, your body can maintain a warmer, calmer, and more comfortable feeling as you go about your daily activities.",
      image: "/media/journey/mat-week-1.webp",
    },
    {
      label: "Month 1",
      title: "Noticeable Relief from Aches and Inflammation",
      description: "After a few weeks of incorporating the grounding mat into your routine, your body can start to feel significantly more comfortable. General aches, joint stiffness, and bodily tension often become less apparent as your system relaxes and circulation reaches optimal levels.",
      image: "/media/journey/step-1.gif",
    },
    {
      label: "Month 3 & Beyond",
      title: "Consistent Comfort and Energy Over Time",
      description: "By making grounding a seamless part of your lifestyle, these positive effects continue to compound. With long-term use, many people discover they feel more energized, less stiff, and profoundly calmer whether they are working, resting, or enjoying everyday life.",
      ...
      <div className="juujo-wrap max-w-5xl">
        <div className="text-center mb-12">
          <h2 className="juujo-display text-3xl md:text-4xl text-[var(--night)] mb-4 font-light">
            Your First 30 Days <span className="text-[var(--clay-deep)] font-normal">Using a Grounding Mat</span>
          </h2>
          <p className="text-[var(--muted)] leading-relaxed max-w-3xl mx-auto text-sm md:text-base">
            Grounding mats work cumulatively. With daily use, many people report feeling calmer, more comfortable, and more refreshed.
          </p>
        </div>
