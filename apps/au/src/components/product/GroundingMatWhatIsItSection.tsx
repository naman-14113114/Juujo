...
export function GroundingMatWhatIsItSection() {
  return (
    <section className="juujo-section bg-white py-14 md:py-24" id="what-is-grounding">
        ...
        <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
          ...
          <div className="w-full">
            <div className="relative aspect-video w-full overflow-hidden rounded-3xl shadow-lg">
              <video
                src={productMediaAsset("a0c706eb701446b5b7b6daf744da9e7a.HD-1080p-7.2Mbps-36900662.mp4", "grounding-mat", "videos")}
                autoPlay
                loop
                muted
                playsInline
