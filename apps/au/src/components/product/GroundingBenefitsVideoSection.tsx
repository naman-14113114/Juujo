...
export function GroundingBenefitsVideoSection() {
  return (
    <section className="juujo-section bg-[var(--cream)] py-14 md:py-24" id="grounding-benefits-video">
        ...
        <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
          ...
          <div className="order-1 w-full">
            <div className="relative aspect-[4/5] w-full max-w-md mx-auto overflow-hidden rounded-3xl shadow-xl">
              <video
                src={productMediaAsset("c902a57fbb1647a3bab2a743ff4e2e3e.HD-1080p-3.3Mbps-32908024.mp4", "grounding-sheets", "videos")}
                autoPlay
                loop
                muted
                playsInline
