...
function ContactHero() {
  return (
    <section className="juujo-section bg-[var(--cream)] py-16 md:py-24">
      <div className="juujo-glow -left-24 top-8 h-[440px] w-[440px] bg-[#f4a17b]" />
      <div className="juujo-glow -right-24 bottom-0 h-[480px] w-[480px] bg-[#a05080]" />

      <div className="juujo-wrap relative z-10 grid gap-12 lg:grid-cols-[1.02fr_.98fr] lg:items-center">
        <div>
          <p className="juujo-eyebrow">{contactPage.eyebrow}</p>
          <h1 className="juujo-display mt-5 text-[3.2rem] leading-[1.02] text-[var(--plum)] sm:text-[4.5rem] md:text-[5.8rem]">
            {contactPage.title.split(" ").slice(0, -1).join(" ")}{" "}
            <em className="juujo-italic">
              {contactPage.title.split(" ").slice(-1).join(" ")}
            </em>
          </h1>
          <p className="juujo-copy mt-6 max-w-2xl text-lg">{contactPage.copy}</p>

          <div className="mt-8 flex flex-wrap gap-3">
            <a
              className="juujo-mono rounded-full bg-[var(--plum)] px-4 py-3 text-[var(--cream)] transition hover:bg-[var(--cream)] hover:text-[var(--ink)]"
...
function HelpAndSocial() {
  return (
    <section className="juujo-section bg-[var(--plum)] py-24 text-[var(--cream)]">
      <div className="juujo-wrap grid gap-12 lg:grid-cols-[.8fr_1.2fr] lg:items-start">
        <SectionHeading
          eyebrow="Help center"
          title={
            <>
              FAQ, help, and <em className="juujo-italic">social updates</em>.
            </>
          }
        ...
        <div className="lg:col-start-2">
          <p className="juujo-mono text-[var(--gold)]">Connect with us</p>
...
function FormSection() {
  return (
    <section className="juujo-section bg-[var(--cream)] py-24" id="contact-form">
      <div className="juujo-glow -left-32 top-10 h-[400px] w-[400px] bg-[#f4a17b]" />
      <div className="juujo-wrap relative z-10 grid gap-12 lg:grid-cols-[.82fr_1.18fr] lg:items-start">
        <div>
          <SectionHeading
            eyebrow="Contact form"
            title={
              <>
                Send us a <em className="juujo-italic">message</em>.
              </>
            }
