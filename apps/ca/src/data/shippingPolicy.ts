export const shippingPolicyHtml = `
  ...
  <p>You will receive a confirmation email and/or text message, if you provided a mobile phone number, containing a tracking ID and a link to follow the journey of your package. You can also visit our <a href="https://juujo.com/order-tracking">Tracking Page</a>. Please allow 1 to 2 business days for tracking information to appear.</p>

  <h2>Wrong address disclaimer</h2>
  <p>It is the buyer's responsibility to make sure the shipping address entered is correct. We do our best to speed up processing and shipping, so there is only a small window to correct an incorrect shipping address. Please contact us immediately at <a href="mailto:support@juujo.com">support@juujo.com</a> if you believe you provided the wrong shipping address.</p>

  <h2>Contact us</h2>
  <p>If you have any questions about our Shipping Policy, please contact us:</p>
  <ul>
    <li>By email: <a href="mailto:support@juujo.com">support@juujo.com</a></li>
