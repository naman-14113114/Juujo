...
export const metadata: Metadata = {
  title: "Order History",
  description: "View your Juujo order history.",
  robots: {
    index: false,
    follow: false,
  },
    ...
    <section className="juujo-section bg-[var(--cream)] py-16 md:py-24">
      <div className="juujo-wrap">
        <div className="mb-10 flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
          <div>
            <p className="juujo-eyebrow">Order history</p>
            <h1 className="juujo-heading mt-3">Your Juujo orders.</h1>
        ...
        {orders.length ? (
              ...
              >
                <div className="flex flex-col justify-between gap-5 border-b border-[var(--border)] pb-5 md:flex-row md:items-center">
                  ...
                  <div className="text-left md:text-right">
                    <p className="juujo-display text-3xl text-[var(--plum)]">
          ...
          <div className="rounded-[2rem] border border-[var(--border)] bg-[var(--card)] p-10 text-center">
            ...
            <h2 className="juujo-display mt-5 text-3xl text-[var(--plum)]">
              No recorded orders yet.
            </h2>
            <p className="juujo-copy mx-auto mt-3 max-w-lg">
              Once you checkout while signed in, your Juujo order record will
              appear here.
            </p>
