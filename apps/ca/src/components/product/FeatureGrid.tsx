                ...
                <li className="border-b border-[var(--border)] last:border-b-0" key={`mobile-${feature.title}`}>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="juujo-display text-[0.95rem] leading-tight text-[var(--plum)] truncate">
                        {feature.title}
                      </h3>
                      <p className="juujo-display mt-0.5 text-[0.8rem] italic text-[var(--plum-soft)] truncate">
                        {feature.kicker}
                      </p>
                    </div>
                    <div className="flex flex-none items-center gap-2">
                      <span className="juujo-display text-sm text-[var(--gold)] font-medium">
                        {String(index + 1).padStart(2, "0")}
                      </span>
                      <Plus
