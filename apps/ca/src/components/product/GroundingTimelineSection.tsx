  ...
  const timeline = [
    {
      ...
      description:
        "Within minutes of using grounding sheets, blood circulation begins improving as red blood cells become less clumped together - helping your body feel calmer, warmer, and more physically relaxed.",
    ...
    },
    {
      ...
      description:
        "Many people report feeling calmer and more comfortable after their first night on grounding sheets. As inflammation begins settling down and circulation improves, aches, tension, and physical discomfort may become less noticeable—making it easier to stay asleep through the night.",
    ...
    },
    {
      ...
      description:
        "After a week of sleeping on grounding sheets, many people report waking up less during the night and falling back asleep more easily. As circulation improves and the body becomes more relaxed, sleep often feels deeper, more stable, and more restorative.",
    ...
    },
    {
      ...
      description:
        "After several weeks of sleeping on grounding sheets, your body recovers more effectively overnight. Back pain, stiffness, and tension often become less noticeable as sleep improves and your body has more time to rest and recover.",
    ...
    },
    {
      ...
      description:
        "With consistent sleep on grounding sheets night after night, recovery improves, stress and stiffness continue settling down, and many people notice steadier energy, easier mornings, and a greater sense of well-being.",
